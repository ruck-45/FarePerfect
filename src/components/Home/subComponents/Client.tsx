...
const Client = () => {
  return (
    <div className=" bg-gray-100 text-black flex flex-col px-[5rem] items-center justify-center md:justify-start md:items-start h-auto md:h-[20rem] w-[73rem]">
      <div className="text-4xl  text-black text-start p-4">
      ...
      <div className="text-thin  font-sans  px-[21rem] md:p-[1rem] ">
        <h3>
          You guys rock! Thank you for making it painless, pleasant and most of all hassle free! I wish I would have
          thought of it first. I am really satisfied with my first laptop service.
        </h3>
      </div>
    </div>
  );
